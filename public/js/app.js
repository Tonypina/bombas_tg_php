...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // We need to import the CSS so that webpack will load it.
...
for (var i = 0; i < herocarousels.length; i++) {
  // Add listener to  event
  herocarousels[i].on('before:show', function (state) {
    console.log(state);
  });
